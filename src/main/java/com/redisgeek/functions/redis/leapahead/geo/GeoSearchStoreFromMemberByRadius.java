...
@Component
public class GeoSearchStoreFromMemberByRadius implements Function<Map<String,String>, Long> {
        private final StringRedisTemplate redisTemplate;
        public GeoSearchStoreFromMemberByRadius(StringRedisTemplate redisTemplate){
