...
@Component
public class GeoSearchFromMemberByRadius implements Function<Map<String,String>, Long> {
        private final StringRedisTemplate redisTemplate;
        public GeoSearchFromMemberByRadius(StringRedisTemplate redisTemplate){
